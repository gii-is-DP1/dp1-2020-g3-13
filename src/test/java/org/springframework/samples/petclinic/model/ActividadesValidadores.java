...
public class ActividadesValidadores {
    ...
    void noDeberiaValidarTematicaActividadVacio(){
        ...
        actividad.setFechaInicio(LocalDateTime.of(2021, 01, 12, 12, 00));
        ...
        Validator validator = createValidator();
	  	  ...
	  	  assertThat(violation.getMessage()).isEqualTo("El campo Tematica no puede estar vacio");
    }
    @Test
    ...
    void noDeberiaValidarDescripcionEnBlanco(){
        ...
        Validator validator = createValidator();
	  	  ...
	  	  assertThat(violation.getMessage()).isEqualTo("El campo descripcion no puede estar vacio");
    }
    @Test
