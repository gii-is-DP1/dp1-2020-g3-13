...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/resources/**", "/webjars/**", "/h2-console/**").permitAll()
				...
				.antMatchers("/eventos/{evento_id}/actividades/{actividad_id}/**").hasAnyAuthority("organizacion")
				...
				.antMatchers("/eventos/{evento_id}").permitAll()
				.antMatchers("/eventos/**").permitAll()
				.antMatchers("/tipoentradas/**").permitAll()
				.antMatchers("/carrito/**").hasAnyAuthority("cliente","organizacion")
