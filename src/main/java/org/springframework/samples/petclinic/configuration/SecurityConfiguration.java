...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/lugaresRealizacion/**").hasAnyAuthority("admin","organizacion")
		...
		.antMatchers("/eventos/**").hasAnyAuthority("organizacion", "cliente", "admin")
		.antMatchers("/tipoentradas/**").permitAll()
		.antMatchers("/carrito/**").hasAnyAuthority("cliente")
		.antMatchers("/actividades/**").hasAnyAuthority("organizacion")
		.antMatchers("/facturas").hasAnyAuthority("organizacion")
	...
	public void configure(AuthenticationManagerBuilder auth) throws Exception {
		auth.jdbcAuthentication()
	      ...
	      .usersByUsernameQuery(
	       "select nombre_usuario,password,enabled "
	        + "from usuarios "
	        + "where nombre_usuario = ?")
	      .authoritiesByUsernameQuery(
	       "select usuario, autoridad "
	        + "from autoridades "
	        + "where usuario = ?")	      	      
