...
INSERT INTO eventos(id,tipo_evento, descripcion, nombre_evento, fecha_inicio, medidas_sanitarias, categoria, fecha_fin, organizacion_id, es_publico) VALUES (3,'CULTURALES_DE_OCIO', 'FITUR es la primera cita anual para los profesionales del turismo mundial', 'FITUR 2021', '2022-10-11', '6M', 'Musica', '2022-10-12', 1, TRUE);
INSERT INTO eventos(id,tipo_evento, descripcion, nombre_evento, fecha_inicio, medidas_sanitarias, categoria, fecha_fin, organizacion_id, es_publico) VALUES (4,'CULTURALES_DE_OCIO', 'Maecenas eu pellentesque eros, sed pulvinar lacus. Proin tempus laoreet mauris', 'The 2021 Financial Checklist', '2022-04-13', '2M', 'Musica', '2022-04-13', 2, TRUE);
INSERT INTO eventos(id,tipo_evento, descripcion, nombre_evento, fecha_inicio, medidas_sanitarias, categoria, fecha_fin, organizacion_id, es_publico) VALUES (5,'CULTURALES_DE_OCIO', 'Integer volutpat augue a quam eleifend euismod. Proin consequat imperdiet leo.', 'Master The Trade: Master Your Money and Mindset For Investing in 2021', '2022-06-11', '2M', 'Musica', '2022-06-15', 2, TRUE);
INSERT INTO eventos(id,tipo_evento, descripcion, nombre_evento, fecha_inicio, medidas_sanitarias, categoria, fecha_fin, organizacion_id, es_publico) VALUES (6,'CULTURALES_DE_OCIO', 'Fusce condimentum tincidunt turpis vel ultricies.', 'Book Club with Margaret Atwood', '2022-02-11', '2M', 'Musica', '2022-05-13', 2, TRUE);
INSERT INTO eventos(id,tipo_evento, descripcion, nombre_evento, fecha_inicio, medidas_sanitarias, categoria, fecha_fin, organizacion_id, es_publico) VALUES (7,'CULTURALES_DE_OCIO', 'ornare lacus suscipit eget. Pellentesque nec fermentum justo. Donec ultricies justo ac porttitor tempor.', 'Reconstruye tu negocio', '2022-08-11', '2M', 'Musica', '2022-08-12', 2, TRUE);
...
INSERT INTO actividad(id,tematica_actividad,descripcion_actividad,fecha_inicio,fecha_fin, alquiler_espacio_id, evento_id) VALUES (11,'Tupac in live', 'accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias,', '2021-04-11 10:00', '2021-04-11 13:00', 2, 2);
